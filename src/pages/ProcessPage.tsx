...
function normalizeDocs(input: unknown): ReferenceDoc[] {
  ...
  return [{ code: "DOC-VEN-001", title: "Guide de qualification des leads", type: "PDF" }];
}

// ✅ Objectifs (dépliable) — supporte string multi-lignes, array, fallback
function normalizeObjectives(input: unknown): string[] {
  if (Array.isArray(input)) {
    const arr = input
